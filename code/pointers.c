//Pointer is pointing to int var or array:
int x = 10;
int* p =&x; //same pointer level
int arr[] = {1,2,5,7,9}; //int*[5]
//int*p = &arr;(warning: initialization of ‘int *’ from incompatible pointer type ‘int (*)[5])
int*p = &arr[0]; //same level(int* to int*)
int (*p)[5] = &arr; //int*[5] to int*[5]
